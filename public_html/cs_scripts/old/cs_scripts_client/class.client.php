...
class client extends base {
    ...
    public static function create_database_user($csv_line) {
        $dbname = '' . $csv_line->short_code; // no prefix
        $username = $csv_line->short_code;
    ...
    public static function create_codebase($csv_line) {
        ...
        symlink("$target/public_html", "/var/www/{$csv_line->short_code}.jeelo.nl");
    ...
    public static function process_client_from_csv($csv_line) {
        ...
        // list($id, $short_code, $domain, $status) = explode(';', $csv_line);
    ...
    public static function process_new_client($csv_line) {
        ...
        self::update_moodle_config($csv_line); 
    ...
    static public function run() {
        ...
        $csv = new csv($response, ';');
        while($csv_line = $csv->nextline()) {
            self::process_client_from_csv($csv_line);
        }
    }
    
    static public function update_moodle_config($csv_line) {
