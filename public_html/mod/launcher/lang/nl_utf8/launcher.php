...
$string['launchername_help'] = 'Dit is de inhoud van het "help tooltip" dat bij de launcher naam hoort.';
$string['launcher'] = 'launcher';
$string['pluginadministration'] = 'launcher administratie';
$string['pluginname'] = 'launcher';
$string['launcher_header'] = 'Welkom bij de launcher!';
