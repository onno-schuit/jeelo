...
$string['header_archiving'] = 'Archiving';
$string['archive_option_label'] = 'Archive existing projects under the following name:';
$string['header_csv_files'] = 'Upload users and groups';
