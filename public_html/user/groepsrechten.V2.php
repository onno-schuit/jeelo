...
//
	...
	*/
	...
	|
	| zoek cursusnaam
	| zoek cursus leerling tekst
	|
	*/
	/*
	$cursus = get_records('course', 'id', $filterselect) ;
	//
	foreach ( $cursus as $c_item) 
	{
		$cursusnaam 		= $c_item->fullname ;
		$leerling_tekst 	= $c_item->student ;	
	}
	*/
	//-----
	...
	/*
	|
	| zoek cursus leerling tekst id
	|
	*/	
	/*
	$leerling = get_records('role', 'name', $leerling_tekst) ;
	//
	foreach ( $leerling as $l_item) 
	{
		$leerling_tekst_id = $l_item->id ;		
	}
	*/
	//-----
